...
small_networks = [
    ...
    (keras_applications.xception.Xception, keras_applications.xception.preprocess_input, 'tf'),
    (keras_applications.mobilenet_v2.MobileNetV2, keras_applications.mobilenet_v2.preprocess_input, 'tf'),
    (keras_applications.nasnet.NASNetMobile, keras_applications.nasnet.preprocess_input, 'tf')
]
